...
| --- | --- | --- |
| Registry convergence | `component` is the canonical runtime/readiness/monitoring object; legacy records require a component binding and cannot be orphaned | migrations `068`–`084`, component DB compatibility tests |
