...
GITHUB_REPO=KajovoCML
GITHUB_TOKEN=gho_example_token_value_1234567890
OCI_REGISTRY=ghcr.io
OCI_IMAGE_NAMESPACE=karelmartinek-a11y/kajovocml-handlers
OCI_CERTIFICATE_IDENTITY=https://github.com/karelmartinek-a11y/KajovoCML/.github/workflows/onboarding-build.yml@refs/heads/main
...
grep -qx 'GITHUB_REPO=KajovoCML' "$tmp/config/worker.env"
