...
cp KajovoCML_Onboarding_Catalog_2026.07.21.docx "$destination/"
cp KajovoCML_Onboarding_Catalog_2026.07.21.pdf "$destination/"
cp docs/onboarding-catalogs/component-2026.07.21.json "$destination/docs/"
cp docs/onboarding-manifest-2026.07.21.example.json "$destination/docs/"
cp apps/server/src/contracts/component-manifest-2026.07.21.schema.json "$destination/docs/"
